...
public record CreateMechanicResource(String firstName, String lastName, Integer dni, String email, Integer age, String location) {
    public CreateMechanicResource {
